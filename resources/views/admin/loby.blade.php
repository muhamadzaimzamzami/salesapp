                                ...
                                <div class="col-xs-12 col-sm-12 m-t-30 col-lg-12">
                                    <div class=" text-center">
                                        ...
                                        <form action="{{ route('checkout') }}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-danger waves-effect waves-light">CheckOut</button>
                                        </form>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 m-t-30 col-lg-12">
                                    <div class=" text-center">
                                        ...
                                        <a href="/checkin-page" type="button" class="btn btn-primary waves-effect waves-light">Checkin</a>
                                    </div>

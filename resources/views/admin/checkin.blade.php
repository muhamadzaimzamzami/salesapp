                        ...
                        <div class="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 m-t-30 col-lg-12">
                                    <form action="{{ route('checkin') }}" method="post" id="formCheck" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input onchange="return validasiEkstensi()" type="file" class="form-control" name="photo" id="photo">
                                            </div>

                                            <div id="preview"></div>
                                        </div>
                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light">CheckIn</button>

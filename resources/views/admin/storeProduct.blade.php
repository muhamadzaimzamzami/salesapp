                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset($data->image)}}" alt="gambar product" width="100" srcset=""></td>
                                    <td>{{ $data->weight }}</td>
                                    <td>{{ $data->stock }}</td>
                                    <td>{{ $data->price_onpieces }}</td>
                                    <td>
                                        <button type="button" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#myModal_{{$data->id}}"><span class="mdi mdi-pencil"></span></button>
                                        <!-- sample modal content -->
                                        <div id="myModal_{{$data->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
